...
const createGpt = async (req, res) => {
  ...
  console.log(sysmtomsData, temperatureData);
  let dbData;
      ...
      messages: [
        {
          role: "system",
          content:
            "You are AI physician chatbot and helpful assistance.You will provide any medical concerns information to the patient ",
        },
        ...assistantData,
        ...messages,
        ...sysmtomsData,
